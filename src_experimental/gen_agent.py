...
class GenerativeAgent(BaseModel):
    ...
    def generate_reaction(self, observation: str) -> Tuple[bool, str]:
        ...
        call_to_action_template = (
            ...
            +"\n If the agent reacts, generate a granular and detailed reaction."
            + "For example, for an observation: {agent_name} wakes up early to go for a run"
            + " before starting his day."
            + "\nREACT: {agent_name} takes a deep breath,"
            + " feeling the cool air filling his lungs, and mentally prepares himself"
            + " for the invigorating workout ahead. With a determined nod, he swings"
            + " his legs over the edge of the bed, already visualizing the satisfaction"
            + " of completing his daily routine."
        ...
        if "REACT:" in result:
            # Output of result is "REACT: Tommie nods and continues with their morning stretches."
            # Extract without the "REACT:" prefix
